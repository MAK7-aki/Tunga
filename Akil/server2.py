...
while(True):
    ...
    print(address)
    string=open("/home/tunga/Desktop/read.txt","r+")
    d=string.read()
    ls = 1 + len(d)
    ...
    if (info[0] == b'T' and info[1] == b'A'):
        ...
        if cmd[0]==b'\x0b' and cmd[1]== b'\x01':
            ...
            os.system("pkill -f /home/tunga/Desktop/Akil/y_auto_stream.py")
            call(["gnome-terminal", "--", "sh", "-c", "python3 /home/tunga/Desktop/Akil/y_auto_stream.py; bash"])
